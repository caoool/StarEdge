Shader "Fast Shadow Projector/FSP_Standard-TerrainFirstPass" {
	Properties {
	...
	Dependency "AddPassShader" = "Fast Shadow Projector/FSP_Standard-TerrainAddPass"
	Dependency "BaseMapShader" = "Fast Shadow Projector/FSP_Standard-TerrainBaseMap"

	Fallback "Fast Shadow Projector/FSP_TerrainFirstPass"
}
