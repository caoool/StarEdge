Shader "Fast Shadow Projector/FSP_TerrainFirstPass" { 
	Properties { 
	...
	Dependency "AddPassShader" = "Fast Shadow Projector/FSP_TerrainAddPass"
	Dependency "BaseMapShader" = "Fast Shadow Projector/FSP_TerrainBaseMap"
}